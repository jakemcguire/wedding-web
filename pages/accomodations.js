        ...
        <div>
            ...
            <section id="accomodations" className={styles.accomodations}>
				...
				<div className={styles.accomodationContainer}>
                    <a href="https://acehotel.com/palm-springs" target="_blank" rel="noreferrer"><div className={styles.title}>The Ace Hotel</div></a>
                    <div className={styles.location}>
                        <a href="https://www.google.com/maps/place/Ace+Hotel+%26+Swim+Club/@33.8009284,-116.5397318,15z/data=!4m2!3m1!1s0x0:0x9a6d0c4d3dba305c?sa=X&ved=2ahUKEwi-7oL__of1AhXVHc0KHegaD8gQ_BJ6BAhGEAU" target="_blank" rel="noreferrer">
                ...
                <div className={styles.accomodationContainer}>
                    <a href="https://www.sonder.com/destinations/palm_springs/Sonder-at-V-Palm-Springs-ADA-Private-Room/c31515" target="_blank" rel="noreferrer"><div className={styles.title}>V Palm Springs</div></a>
                    <div className={styles.location}>
                        <a href="https://www.google.com/maps/place/Sonder+%7C+V+Palm+Springs/@33.8009228,-116.5437056,15z/data=!4m2!3m1!1s0x0:0xd69599e50f5e35f6?sa=X&ved=2ahUKEwiT24SU7Iz1AhXTB80KHYWOCq4Q_BJ6BAgNEAU" target="_blank" rel="noreferrer">
                            <Image src={pinSvg} width={16} height={16} />
                            <span className={styles.address}>333 E. Palm Canyon Dr, Palm Springs, CA 92264</span>
                        </a>
                    </div>
                    <div className={styles.description}>V Palm Springs is a short walk from all weekend activities. Our guests can receive a 10% discount with code VWEDDING10, valid for bookings up to 2 weeks before the wedding. Guests are encouraged to book directly through <a href="https://www.sonder.com/destinations/palm_springs/Sonder-at-V-Palm-Springs-ADA-Private-Room/c31515" target="_blank" rel="noreferrer">the V Hotel website</a>.</div>
                </div>
			</section>
            <section id="travel" className={styles.accomodations}>
                ...
                <div className={styles.accomodationContainer}>
                    ...
                    <div className={styles.description}>Palm Springs International Airport (PSP) is two miles east of downtown Palm Springs, a short 8-minute drive from where all of our festivities will take place. There are direct flights into Palm Springs from Denver (via United), New York JFK (via JetBlue), and San Francisco (via Alaska and United).</div>
                </div>
                <div className={styles.accomodationContainer}>
                ...
                <div className={styles.accomodationContainer}>
                    <div className={styles.description}>
                        ...
                        <ul>
                            ...
                            <li>Additionally, Palm Springs has an indoor masking requirement for public spaces. At this time our event would not fall under the masking mandate, but we will update guests on the <a href="https://www.palmspringsca.gov/government/covid-19-updates" target="_blank" rel="noreferrer">latest guidance</a> closer to the event.</li>
                        </ul>
                    </div>
                </div>
            </section>
